        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-pull-6">
                <h2 class="section_header thin">
                    Story of
                    <strong>social activism</strong>
                </h2>
                <p>
                    Filet mignon turducken andouille, pork belly salami tongue short ribs porchetta shoulder short loin picanha drumstick tenderloin ham hock. Pork loin prosciutto ball tip, rump frankfurter kevin swine jerky t-bone sausage short ribs pork chop beef pastrami ribeye. Andouille tri-tip burgdoggen biltong, venison tail chuck shank hamburger kielbasa capicola boudin shoulder shankle salami. Sirloin beef ribs filet mignon rump tenderloin frankfurter turkey bacon drumstick. Cow ham boudin tongue short ribs beef ribs venison.prosciutto beef andouille cupim briske pig swine doner burgdoggen.
                </p>
                <ul class="list2 checklist grey semibold">
                    <li>Pancetta corned beef chicken picanha</li>
                    <li>Turducken salami frankfurter burgdo</li>
                    <li>Turkey shank ribeye meatloaf fatback</li>
                </ul>
            </div>
        </div>
    </div>
