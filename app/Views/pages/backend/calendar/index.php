                    ...
                    <div class="row admin-table-filters">
                        ...
                        <div class="col-lg-3 text-lg-right">
                            <div class="widget widget_search">
                                ...
                                <form method="get" action="<?=route_to('backend.calendar.index')?> ">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <?php foreach ($calendars as $data){ ?>
                                ...
                                <td class="media-middle">
                                    <h5>
                                        <a href="<?=route_to('backend.calendar.edit',$data['id']) ?>">
                                            <?= $data['title']?>
                                        </a>
                                    </h5>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <a class="btn btn-link " href="<?=route_to('backend.calendar.edit',$data['id']) ?>">
                                            <i class="fa fa-pencil-square-o text-success" aria-hidden="true"></i></a>
                                        <a class="btn btn-link " href="<?=route_to('backend.calendar.delete',$data['id']) ?>">
