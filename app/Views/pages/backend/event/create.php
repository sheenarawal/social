...
<section class="ls section_padding_top_50 section_padding_bottom_50 columns_padding_10">
    <div class="container-fluid">
        ...
        <form class="form-horizontal" action="<?=route_to('backend.event.store')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="with_border with_padding">
                        <h4>Event text
                            <span class="pull-right">
                                <button type="submit" class="theme_button small_button">Save Event</button>
                            </span>
                        </h4>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                <button type="submit" class="theme_button wide_button">Save Event</button>
