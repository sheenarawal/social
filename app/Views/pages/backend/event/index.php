                    ...
                    <div class="row admin-table-filters">
                        ...
                        <div class="col-lg-3 text-lg-right">
                            <div class="widget widget_search">
                                ...
                                <form method="get" action="<?=route_to('backend.event.index')?> ">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <?php foreach ($events as $data){ ?>
                                ...
                                <td class="media-middle">
                                    <h5>
                                        <a href="<?=route_to('backend.event.edit',$data['id']) ?>">
                                            <?= $data['title']?>
                                        </a>
                                    </h5>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <a class="btn btn-link " href="<?=route_to('backend.event.edit',$data['id']) ?>">
                                            <i class="fa fa-pencil-square-o text-success" aria-hidden="true"></i></a>
                                        <a class="btn btn-link " href="<?=route_to('backend.event.delete',$data['id']) ?>">
