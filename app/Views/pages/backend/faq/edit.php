...
<section class="ls section_padding_top_50 section_padding_bottom_50 columns_padding_10">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <form class="form-horizontal" action="<?=route_to('backend.faq.update',$faq['id'])?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="with_border with_padding">
                        <h4>Faq text
                            <span class="pull-right">
                                <button type="submit" class="theme_button small_button">Update Faq</button>
                            </span>
                        </h4>
                        <hr>
                        <div class="row form-group <?php if(session('errors.question')) : ?> has-error<?php endif ?>">
                            ...
                            <div class="col-lg-9">
                                <input name="faq_id" type="hidden" value="<?=esc($faq['id'])?>">
                                <input type="text" class="form-control" id="question" name="question" value="<?= esc($faq['title']) ?>" required>
                        ...
                        <div class="row form-group <?php if(session('errors.answer')) : ?> has-error<?php endif ?>">
                            ...
                            <div class="col-lg-9">
                                <textarea rows="8" class="form-control" name="answer" id="answer"><?= esc($faq['description'])?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <label class="radio-inline" for="status1">
                                    <input type="radio" name="status" id="status1" value="0" checked="<?=esc($faq['status'])== 0?'checked':'' ?>"> Draft
                                </label>
                                <label class="radio-inline" for="status2">
                                    <input type="radio" name="status" id="status2" value="1" <?=esc($faq['status'])== 1?'checked':'' ?>> Published
                                </label>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                <button type="submit" class="theme_button wide_button">Update Faq</button>
