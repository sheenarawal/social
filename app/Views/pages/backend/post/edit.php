...
<section class="ls section_padding_top_50 section_padding_bottom_50 columns_padding_10">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <form class="form-horizontal" action="<?=route_to('backend.post.update')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="with_border with_padding">
                        <h4>Post text
                            <span class="pull-right">
                                <button type="submit" class="theme_button small_button">Update Post</button>
                            </span>
                        </h4>
                        <hr>
                        <div class="row form-group <?php if(session('errors.title')) : ?> has-error<?php endif ?>">
                            ...
                            <div class="col-lg-9">
                                <input name="post_id" type="hidden" value="<?=esc($post['id'])?>">
                        ...
                        <div class="row form-group <?php if(session('errors.category')) : ?> has-error<?php endif ?>">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="category" name="category" value="<?= esc($post['category'])?>" required>
                        ...
                        <div class="row form-group <?php if(session('errors.address')) : ?> has-error<?php endif ?>">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="tag" id="tag" value="<?= esc($post['tag'])?>" required>
                        ...
                        <div class="row form-group <?php if(session('errors.description')) : ?> has-error<?php endif ?>">
                            ...
                            <div class="col-lg-9">
                                <textarea rows="8" class="form-control" name="description" id="description"><?= esc($post['description'])?></textarea>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                <button type="submit" class="theme_button wide_button">Update Post</button>
                ...
                <div class="col-md-4">
                    <div class="with_border with_padding bottommargin_10">
                        ...
                        <div class="row form-group <?php if(session('errors.publish_date')) : ?> has-error<?php endif ?>">
                            ...
                            <div class="col-lg-9">
                                <input type="date" class="form-control" name="publish_date" id="publish_date" value="<?=  esc($post['publish_date'])? esc($post['publish_date']):date('Y-m-d') ?>" required>
                        ...
                        <div class="row form-group <?php if(session('errors.publish_time')) : ?> has-error<?php endif ?>">
                            ...
                            <div class="col-lg-9">
                                <input type="time" class="form-control" name="publish_time" id="publish_time" value="<?=  esc($post['publish_time'])? esc($post['publish_time']):date('h:i:s') ?>" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <label class="radio-inline" for="status1">
                                    <input type="radio" name="status" id="status1" value="0" checked="<?= esc($post['status'])== 0?'checked':'' ?>"> Draft
                                </label>
                                <label class="radio-inline" for="status2">
                                    <input type="radio" name="status" id="status2" value="1" <?= esc($post['status'])== 1?'checked':'' ?>> Published
                                </label>
