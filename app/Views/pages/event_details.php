					...
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							Home
								...
								<li class="active">Event left sidebar</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-sm-7 col-md-8 col-lg-8 col-sm-push-5 col-md-push-4 col-lg-push-4">
							...
							<article class="event-single vertical-item content-padding big-padding with_border rounded">
								<div class="item-media entry-thumbnail top_rounded overflow_hidden">
									<img src="/assets/images/gallery/<?php echo $entry['media']; ?>" alt="">
								</div>
								...
								<span class="rightpadding_20"><i class="fa fa-calendar rightpadding_5 highlight"></i> <?php echo $entry['publish_date']; ?></span>
