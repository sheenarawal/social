                        ...
                        <div class="row">
                                ...
                                <div class="item-media">
                                    ...
                                    <div class="media-links">
                                        <a class="abs-link" title=""
                                           href="event-details/<?php echo $event['id']; ?>"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7">
                                <div class="item-content">
                                    <h4>
                                        <a href="<?= route_to('frontend.event.details', $event['id']); ?>"><?php echo $event['title']; ?></a>
                                    </h4>

                                    <p class=" grey darklinks">
                                        <span class="rightpadding_20"><i
                                                    class="fa fa-calendar rightpadding_5 highlight"></i> <?php echo $event['publish_date']; ?></span>
