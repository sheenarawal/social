                    ...
                    <div class="rounded overflow_hidden">
                        ...
                        <div class="with_padding with_background">
                            ...
                            <div class="widget widget_slider widget_featured_posts">
                                ...
                                <div class="owl-carousel" data-nav="true" data-loop="true" data-autoplay="true"
                                     data-items="1" data-responsive-lg="1" data-responsive-md="1" data-responsive-sm="1"
                                     data-responsive-xs="1">
                                    <ul>
                                        <li class="media big-left-media">
                                            <div class="media-left media-middle">
                                                <img src="assets/images/post-thumbs/01.jpg" alt="">
                                            </div>
                                        ...
                                        <li class="media big-left-media">
                                            <div class="media-left media-middle">
                                                <img src="assets/images/post-thumbs/02.jpg" alt="">
                                            </div>
                                            <div class="media-body media-middle">
                                                <h4>
                                                    <a href="blog-single-right.html">
                                        ...
                                        <li class="media big-left-media">
                                            <div class="media-left media-middle">
                                                <img src="assets/images/post-thumbs/03.jpg" alt="">
                                            </div>
                                            <div class="media-body media-middle">
                                                <h4>
                                                    <a href="blog-single-right.html">
                                    ...
                                    <ul>
                                        <li class="media big-left-media">
                                            <div class="media-left media-middle">
                                                <img src="assets/images/post-thumbs/04.jpg" alt="">
                                            </div>
                                            <div class="media-body media-middle">
                                                <h4>
                                                    <a href="blog-single-right.html">
                                        ...
                                        <li class="media big-left-media">
                                            <div class="media-left media-middle">
                                                <img src="assets/images/post-thumbs/05.jpg" alt="">
                                            </div>
                                            <div class="media-body media-middle">
                                                <h4>
                                                    <a href="blog-single-right.html">
                                        ...
                                        <li class="media big-left-media">
                                            <div class="media-left media-middle">
                                                <img src="assets/images/post-thumbs/06.jpg" alt="">
                                            </div>
                                            <div class="media-body media-middle">
                                                <h4>
                                                    <a href="blog-single-right.html">
                                            ...
                                            <div class="col-sm-12 text-center">
                                                <div class="slide_description_wrapper">
                                                    <div class="slide_description">
                                                        ...
                                                        <div class="intro-layer to_animate" data-animation="fadeInUp">
                                                            <a href="about.html" class="theme_button color1">Sign up
                                                                now</a>
                                                        </div>
                                                    </div>
                                                    <!-- eof .slide_description -->
                                            ...
                                            <div class="col-sm-12 text-center">
                                                <div class="slide_description_wrapper">
                                                    <div class="slide_description">
                                                        ...
                                                        <div class="intro-layer to_animate" data-animation="fadeInUp">
                                                            <a href="about.html" class="theme_button color1">How to
                                                                get</a>
                                                        </div>
                                                    </div>
                                                    <!-- eof .slide_description -->
