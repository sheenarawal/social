    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7 col-md-8 col-lg-8 col-sm-push-5 col-md-push-4 col-lg-push-4">
                <article class="single-post vertical-item content-padding big-padding post with_border rounded">
                    ...
                    <div class="item-content">
                        ...
                        <header class="entry-header">
                            ...
                            <div class="muted_background post-adds content-justify rounded hidden">
                        ...
                        <div class="entry-content"><?php $post['description']?></div>
                        <!-- .entry-content -->
                ...
                <div class="with_padding big-padding with_border comments-wrapper hidden">
                    ...
                    <div class="comment-respond" id="respond">
                        ...
                        <form class="comment-form columns_padding_10" id="commentform" method="post" action="https://html.modernwebtemplates.com/social-activism/">
                            <div class="row">
                                <div class="col-sm-6">
                ...
                <div class="row columns_padding_5 page-nav">
                    ...
                    <div class="col-md-6">
                        <div class="with_padding text-center ds bg_teaser after_cover darkblue_bg">
                            <img src="<?= base_url('uploads/'.$prev->media)?>" alt="">
                            <div>
                                <div class="highlight small-text">
                                    Prev
                                </div>
                                <h4 class="semibold">
                                    <a href="<?= route_to('frontend.post.show',$prev->id) ?>" rel="bookmark"><?= $prev->title?></a>
                                </h4>
                            </div>
                            <!-- eof .item-content -->
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="with_padding text-center ds bg_teaser after_cover darkblue_bg">
                            <img src="<?= base_url('uploads/'.$next->media)?>" alt="">
                            <div class="item-content">
                                <div class="highlight small-text">
                                    Next
                                </div>
                                <h4 class="semibold">
                                    <a href="<?= route_to('frontend.post.show',$next->id)?>" rel="bookmark"><?= $next->title?></a>
                                </h4>
                            </div>
                            <!-- eof .item-content -->
                        </div>
            ...
            <aside class="col-sm-5 col-md-4 col-lg-4 col-sm-pull-7 col-md-pull-8 col-lg-pull-8">
                ...
                <div class="widget widget_flickr hidden">
